...
const FeatureCard = ({ icon, title, content, index }) => (
    <div className={`py-0 flex flex-row rounded-[20px] lg:px-5
    ${index !== features.length - 1 ? "mb-6" : "mb-0"} `}>
        ...
        <div className="flex-1 flex flex-col">
            <h4 className="font-poppins font-semibold text-white text-[20px] leading-[32px] mb-2">
                {title}
            </h4>
...
const Confiabilidad = () => (
    ...
    my-2 min-w-[140px] rounded-xl sidebar items-start`}>
        <div className={`${layout.sectionInfo}`}>
            ...
            <p className={`${styles.paragraph} max-w-[900px]`}>La Melena de León es un hongo medicinal con potentes beneficios cognitivos. Nuestras cápsulas están elaboradas con ingredientes seguros, puros y orgánicos para que puedas disfrutar de todos sus beneficios sin preocupaciones.</p>
