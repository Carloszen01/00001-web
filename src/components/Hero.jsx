    ...
    return (
        <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16`}>
                ...
                <div className='flex flex-row justify-betweem items-center w-full'>
                    <h1 className='flex-1 font-poppins font-semibold ss:text-[70px] text-[48px]
                    text-white ss:leading-[100px] leading-[75px]'>
                        ¿Quieres Mejorar <br className='sm:block hidden' /> {" "}
                        <span className='text-gradient'> Tu Potencial
                        </span> {" "}
                    </h1>
                ...
                <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
                    ¡Mejora tu concentración, memoria y estado de ánimo con nootrópicos naturales!
                </p>
            </div>
